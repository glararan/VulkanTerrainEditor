...
namespace Vulkan
{
	...
	void SwapChain::create(uint32_t* width, uint32_t* height, bool vsync = false)
	{
	...
	VkResult SwapChain::queuePresent(VkQueue queue, uint32_t imageIndex, VkSemaphore waitSemaphore = VK_NULL_HANDLE)
	{
