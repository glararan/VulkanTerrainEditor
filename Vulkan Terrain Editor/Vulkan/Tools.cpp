...
#undef STR
		...
		VkBool32 getSupportedDepthFormat(QVulkanDeviceFunctions* functions, VkPhysicalDevice physicalDevice, VkFormat* depthFormat)
		{
			...
			for(auto& format : depthFormats)
			{
				...
				functions->vkGetPhysicalDeviceFormatProperties(physicalDevice, format, &formatProps);
		...
		void setImageLayout(QVulkanDeviceFunctions* functions, VkCommandBuffer cmdbuffer, VkImage image, VkImageLayout oldImageLayout, VkImageLayout newImageLayout, VkImageSubresourceRange subresourceRange, VkPipelineStageFlags srcStageMask, VkPipelineStageFlags dstStageMask)
		{
			...
			functions->vkCmdPipelineBarrier(cmdbuffer, srcStageMask, dstStageMask, 0, 0, nullptr, 0, nullptr, 1, &imageMemoryBarrier);
		}

		// Fixed sub resource on first mip level and layer
		void setImageLayout(QVulkanDeviceFunctions* functions, VkCommandBuffer cmdbuffer, VkImage image, VkImageAspectFlags aspectMask, VkImageLayout oldImageLayout, VkImageLayout newImageLayout, VkPipelineStageFlags srcStageMask, VkPipelineStageFlags dstStageMask)
		{
			...
			setImageLayout(functions, cmdbuffer, image, oldImageLayout, newImageLayout, subresourceRange, srcStageMask, dstStageMask);
		}
